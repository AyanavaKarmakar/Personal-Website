...
export const ExtrasTexts: ExtraText[] = [
  ...
  },
  {
    ...
    para5: "— Metro: 2033 / Last Light / Exodus [90/100]",
    para6: "— Ghost of Tsushima [90/100]",
    para7: "— Grand Theft Auto San Andreas [85/100]",
    para8: "— The Witcher 3: Wild Hunt [80/100]",
    para9: "— Far Cry 3 [75/100]",
  },
  // {
  //   id: 6,
