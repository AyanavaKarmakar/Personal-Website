...
export const Home = (props: Props) => {
  ...
  return (
    ...
    >
      <Typography variant="h4" color={`${darkMode === true ? 'secondary' : 'primary'}`}>
        <TypeAnimation sequence={['Ayanava Karmakar', 1000]} speed={50} wrapper="span" repeat={0} />
      </Typography>
      <Typography variant="h5" color={`${darkMode === true ? 'secondary' : 'primary'}`}>
        <TypeAnimation
          sequence={[
            'Frontend Developer',
            1000,
      ...
      <Typography variant="h6" color={`${darkMode === true ? 'secondary' : 'primary'}`}>
        <TypeAnimation
